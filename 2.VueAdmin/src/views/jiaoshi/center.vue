				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="教师密码" prop="jiaoshimima">
							<el-input class="list_inp" v-model="user.jiaoshimima" readonly placeholder="教师密码" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
					...
					<el-col :span="24">
						<el-form-item label="简介" prop="jianjie">
							<el-input class="list_inp" v-model="user.jianjie"  placeholder="简介" clearable />
						</el-form-item>
					</el-col>

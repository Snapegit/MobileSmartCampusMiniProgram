	...
	<div>
		<div class="login_view">
			<el-form :model="loginForm" class="login_form">
				<div class="title_view">基于SpringBoot的智慧校园微信小程序登录</div>
...
<style lang="scss" scoped>
	.login_view {
		...
		background: url(http://chy2.gdnxeco.com/20230913/653c874587284998875920e0d70a9d11.jpg) no-repeat center center / cover;
		display: flex;
		min-height: 100vh;
		...
		.title_view {
			...
			margin: 0 auto 20px;
			color: #5d5b5c;
			background: url(http://chy2.gdnxeco.com/20230913/0f7f5c7f72e94c929cc9841d0835f49d.png) no-repeat left bottom;
			font-weight: 600;
			width: 80%;
			font-size: 26px;
			text-align: left;
